<script id="prices-template" type="text/x-custom-template">
    <div class="row animated fadeIn single-price">
                ...
                @foreach ($attributeGroups as $attributeGroup)
                    <div class="col-md-3 col-12">
                        <div class="form-group">
                            ...
                            <select class="form-control price-attribute-select select2" name="attribute">
                                <option value="">انتخاب کنید</option>
                                @foreach ($attributeGroup->get_attributes()->orderBy('name')->get() as $attribute)
        ...
        <div class="col-md-3 col-12">
            <div class="form-group">
                <label>کد کالا</label>
                <input type="text" class="form-control productCode" name="productCode" id="productCode">
            </div>
        </div>
