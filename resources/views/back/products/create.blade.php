                        ...
                        <div class="col-md-12">
                            <div class="card overflow-hidden">
                                <div class="card-header">
                                    ...
                                    <div class="pr-25 custom-align-left">
                                        <a href='{{route('admin.products.excel.upload.form')}}' type="submit" class="btn btn-primary">آپلود فایل اکسل</a>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="nav-vertical">
                                            <ul class="nav nav-tabs nav-left flex-column" role="tablist">
                                                ...
                                                <li class="nav-item physical-item">
                                                    <a class="nav-link" id="" data-toggle="tab" aria-controls="tabSize"
                                                       href="#tabSize" role="tab" aria-selected="false">سایز بندی</a>
                                                </li>
                                            </ul>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3 col-12 physical-item">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                               name="unit"
                                                                               value="{{ $copy_product ? $copy_product->unit : 'تعداد' }}">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12 text-center mt-2">
                                                                    ...
                                                                    <button id="copy-product-prices" type="button"
                                                                            class="btn btn-outline-primary waves-effect waves-light">
                                                                        <i class="feather icon-copy"></i> کپی آخرین قیمت
                                                                    </button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                                                ...
                                                                                                <div class="row">
                                                                                                        ...
                                                                                                        <fieldset>
                                                                                                            <label>
                                                                                                                <input
                                                                                                                    ...
                                                                                                                    type="checkbox" {{ $specification['special'] ? 'checked' : '' }}>
                                                                                                            </label>
                                                                                                        </fieldset>
                                                                                                    </div>
                                                                                                    <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <textarea
                                                                                                            ...
                                                                                                            required>{!! $specification['value'] !!}</textarea>
                                                                                                    </div>
                                                                                                    <div
                                                                                                        class="col-md-1">
                                                                                                        <button
                                                                ...
                                                                <div class="col-md-6">
                                                                    <fieldset class="form-group">
                                                                        ...
                                                                        <input type="text" name="tags"
                                                                               ...
                                                                               value="{{ $copy_product ? $copy_product->getTags : option('product_default_tags') }}">
                                                                    </fieldset>
                                                                </div>
                                                    ...
                                                    <fieldset>
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input"
                                                                   name="published" id="customRadio1" value="1" checked>
...
@push('scripts')
    ...
    <script src="{{ asset('back/assets/js/pages/products/all.js') }}?v=11"></script>
