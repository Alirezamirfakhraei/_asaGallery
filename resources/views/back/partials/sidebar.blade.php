<div
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <ul class="menu-content">
                        ...
                        @can('products.sizetypes')
                            <li class="{{ active_class('admin.sizetypes.index') }}">
                                <a href="{{ route('admin.sizetypes.index') }}"><i class="feather icon-circle"></i><span
                        ...
                        @can('products.prices')
                            <li class="{{ active_class('admin.product.prices.index') }}">
                                <a href="{{ route('admin.product.prices.index') }}"><i
                                        class="feather icon-circle"></i><span class="menu-item">قیمت ها</span></a>
                            </li>
                        @endcan
                                        ...
                                        <li class="{{ active_class('admin.attributeGroups.create') }}">
                                            <a class="{{ active_class('admin.attributeGroups.create') }}"
                                               href="{{ route('admin.attributeGroups.create') }}"><i
                                                    class="feather icon-circle"></i><span class="menu-item">ایجاد گروه ویژگی</span></a>
                                        </li>
                                    @endcan
                                        ...
                                        <li class="{{ active_class('admin.filters.index') }}">
                                            <a class="{{ active_class('admin.filters.index') }}"
                                               href="{{ route('admin.filters.index') }}"><i
                                                    class="feather icon-circle"></i><span class="menu-item">لیست فیلتر ها</span></a>
                                        </li>
                                    @endcan
            ...
            @can('orders')
                <li class="nav-item has-sub {{ open_class(['admin.orders.*']) }}"><a href="#"><i
                    ...
                    <ul class="menu-content">
                        ...
                        @can('orders.index')
                            <li class="">
                                <a href="{{ route('admin.orders.index') }}?status=paid&shipping_status=reserved"><i
                                        class="feather icon-circle"></i><span class="menu-item">سفارشات رزرو شده</span></a>
                            </li>
                        @endcan
                        ...
                        @can('orders.create')
                            <li class="{{ active_class('admin.orders.create') }}">
                                <a href="{{ route('admin.orders.create') }}"><i class="feather icon-circle"></i><span
                        ...
                        @can('links.groups')
                            <li class="{{ active_class('admin.links.groups.index') }}">
                                <a href="{{ route('admin.links.groups.index') }}"><i
                                        class="feather icon-circle"></i><span class="menu-item">لیست گروه ها </span></a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('pages')
                <li class="nav-item has-sub {{ open_class(['admin.pages.*']) }}"><a href="#"><i
                    ...
                    <ul class="menu-content">
                        ...
                        @endcan
                        {{--catalog page--}}
                        <li class="{{ active_class('admin.pages.catalog') }}">
                            <a href="{{route('admin.catalog.page')}}"><i class="feather icon-circle"></i><span
                                    class="menu-item">کاتالوگ ها</span></a>
                        </li>
                        {{--catalog page--}}
                        @can('pages.create')
                        ...
                        @can('statistics.orders')
                            <li class="{{ active_class('admin.statistics.orders') }}">
                                <a href="{{ route('admin.statistics.orders') }}"><i
                                        class="feather icon-circle"></i><span class="menu-item">سفارشات</span></a>
                            </li>
                        @endcan
                        ...
                        @can('statistics.viewsList')
                            <li class="{{ active_class('admin.statistics.viewsList') }}">
                                <a href="{{ route('admin.statistics.viewsList') }}"><i
                                        class="feather icon-circle"></i><span class="menu-item">لیست بازدیدها</span></a>
                            </li>
                        @endcan
                            ...
                            @if(config('front.settings.fields'))
                                <li class="{{ active_class('admin.themes.settings') }}">
                                    <a href="{{ route('admin.themes.settings') }}"><i
                                            class="feather icon-circle"></i><span class="menu-item">تنظیمات قالب</span></a>
                                </li>
                            @endcan
                        @endcan
            ...
            @can(['comments'])
                <li class="nav-item has-sub {{ open_class(['admin.comments.*']) }}"><a href="#"><i
                            class="feather icon-message-circle"></i><span class="menu-title"> نظرات</span></a>
                    <ul class="menu-content">
                        ...
                        @can('settings.information')
                            <li class="{{ active_class('admin.settings.information') }}">
                                <a href="{{ route('admin.settings.information') }}"><i
                                        class="feather icon-circle"></i><span class="menu-item">اطلاعات کلی</span></a>
                            </li>
                        @endcan
                        ...
                        @can('settings.gateway')
                            <li class="{{ active_class('admin.settings.gateways') }}">
                                <a href="{{ route('admin.settings.gateways') }}"><i
                                        class="feather icon-circle"></i><span class="menu-item">درگاه های پرداخت</span></a>
                            </li>
                        @endcan
                ...
                <li class="nav-item has-sub">
                    ...
                    <ul class="menu-content">
                        <li class="{{ active_class('admin.permissions.index') }}">
                            <a href="{{ route('admin.permissions.index') }}"><i class="feather icon-circle"></i><span
                                    class="menu-item">دسترسی ها</span></a>
                        </li>

                        <li class="{{ active_class('admin.developer.settings') }}">
                            <a href="{{ route('admin.developer.settings') }}"><i class="feather icon-circle"></i><span
                        ...
                        <li class="{{ active_class('admin.developer.showUpdater') }}">
                            <a href="{{ route('admin.developer.showUpdater') }}"><i
                                    class="feather icon-circle"></i><span class="menu-item">بروزرسانی</span></a>
                        </li>
