...
@if ($products->count())
    <section class="slider-section mb-3 amazing-section"
             style="background: {{ $widget->option('block_color', '#ef394e') }}">
                                ...
                                <div class="amazing-product text-center pt-5">
                                    @if ($widget->option('image'))
                                        <a href="{{ $widget->option('link') }}">
                                            <img src="https://asagallery.shop/themes/defaultTheme/img/theme/amazing-1.png" alt="special products">
{{--                                            <img src="{{ $widget->option('image') }}" alt="special products">--}}
                                        </a>
                                    @endif
