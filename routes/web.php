...
use App\Http\Controllers\CatalogOfProductsController;
...
Route::group(['as' => 'admin.', 'prefix' => 'admin/' . admin_route_prefix(), 'middleware' => ['auth', 'Admin', 'verified', 'CheckPasswordChange', 'password.confirm']], function () {
    ...
    // ------------------ nilaro
    Route::get('nila/clients', [ClientController::class, 'getClients'])->name('nila.getClients');
    Route::get('nila/client/create', [ClientController::class, 'create'])->name('nila.client.create');
    Route::post('nila/client', [ClientController::class, 'store'])->name('nila.client.store');
    Route::get('nila/client/{client}/edit', [ClientController::class, 'edit'])->name('nila.client.edit');
    Route::put('nila/client/{client}', [ClientController::class, 'update'])->name('nila.client.update');
    Route::delete('nila/client/{client}', [ClientController::class, 'destroy'])->name('nila.client.destroy');
    Route::get('nila/client/{client}', [ClientController::class, 'show'])->name('nila.client.show');
    Route::get('clients/search', [ClientController::class, 'search'])->name('clients.search');
    Route::get('subClients/add/{id}', [ClientController::class, 'addSubClientView'])->name('subClients.add.view');
    ...
    Route::get('products/excel/upload', [ProductController::class, 'showUploadFormExcel'])->name('products.excel.upload.form');
    Route::get('products/excel/download-template', [ProductController::class, 'downloadFileExcelTemplate'])->name('products.excel.download');
    Route::post('products/save', [ProductController::class, 'uploadFileExcel'])->name('products.save');
    ...
    //catalog
    Route::get('catalog', [PageController::class, 'catalogs'])->name('catalog.page');
    Route::get('catalog/create', [PageController::class, 'createCatalog'])->name('catalog.create');
    Route::post('catalog', [PageController::class, 'storeCatalog'])->name('catalog.store');
    Route::get('catalog/{catalog}/edit', [PageController::class, 'editCatalog'])->name('catalog.edit');
    Route::put('catalog/{catalog}', [PageController::class, 'updateCatalog'])->name('catalog.update');
    Route::delete('catalog/{catalog}/delete', [PageController::class, 'destroyCatalog'])->name('catalog.destroy');
    Route::post('catalog/api/index', [PageController::class, 'apiIndex'])->name('catalog.apiIndex');
...
Route::get('catalogsOfProducts', [CatalogOfProductsController::class, 'view']);
