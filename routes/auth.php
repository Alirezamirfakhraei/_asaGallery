...
use App\Http\Controllers\Back\NilaController;
use Illuminate\Support\Facades\Route;

// نمایش فرم ورود
Route::get('nila/client/login', [ClientController::class, 'showLoginForm'])->name('client.login');
// ارسال فرم ورود (بدون middleware!)
Route::post('nila/client/login', [ClientController::class, 'login'])->name('client.login.submit');
Route::post('nila/client/logout', [ClientController::class, 'logout'])->name('client.logout');
...
Route::get('/login', [AuthenticatedSessionController::class, 'create'])
    ...
    // Route::redirect("/login", "/login-with-code")->name('login');
